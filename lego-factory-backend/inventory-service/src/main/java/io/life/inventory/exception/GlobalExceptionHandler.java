...
/**
 * Global exception handler for consistent error responses across the inventory service.
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handle generic InventoryException
     */
    ...
    public ResponseEntity<ApiErrorResponse> handleInventoryException(
        ...
        logger.error("Inventory error: {} (Code: {})", ex.getMessage(), errorCode, ex);
